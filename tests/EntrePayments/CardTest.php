...
class CardTest extends TestCase
{
    ...
    public function testValidCardData(): void
    {
        ...
        $this->assertEquals($year . $month, $card->getExpiration());
    ...
    /**
     * @testdox The default 3Ds version is the version 2.0, but we can change to 1.0
     */
    public function testTheDefault3DSVersionIs2(): void
    {
        $debitCard = Card::debitCard(
            '5276652150489056',
            (string)((int)date('y') + 2),
        ...
        $this->assertEquals(Card::THREE_D_SECURE_VERSION_2, $debitCard->getThreeDSecureVersion());
        ...
        $debitCard = Card::debitCard(
            ...
            'Fulano de Tal',
            '123',
            Card::THREE_D_SECURE_VERSION_1
        );

        $this->assertEquals(Card::THREE_D_SECURE_VERSION_1, $debitCard->getThreeDSecureVersion());
    }
